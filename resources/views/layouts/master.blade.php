						...
						<div class="emphasis-title mb-2">
							...
							<h1>
								<span id="oc-images" class="owl-carousel image-carousel carousel-widget" data-items="1" data-margin="0" data-autoplay="3000" data-loop="true" data-nav="false" data-pagi="false" data-animate-in="fadeInUp">
									<div class="oc-item gradient-text gradient-red-yellow text-uppercase">KABUPATEN SITUBONDO</div>
				...
				<div class="section mb-0 pt-3 pb-0" style="background-color: #F4F4F4; margin-top: 150px; overflow: visible;">
					...
					<div class="container">
						<div class="row justify-content-center text-center mt-5">
							<div class="col-lg-6">
								<div>
									<h3 class="fw-bolder h1 mb-4">KORPRI KABUPATEN SITUBONDO <span class="gradient-text gradient-horizon">Germany</span></h3>
									<p class="mb-5 lead text-black-50 fw-extralight">KORPRI Kabupaten SITUBONDO berada di Kantor BKPSDM Kabupaten Situbondo</p>
								</div>
							</div>
						</div>
					</div>
