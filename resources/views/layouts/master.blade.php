            ...
            <div class="section mb-0 pt-3 pb-0"
                ...
                <div class="container">
                    <div class="row justify-content-center text-center mt-5">
                        <div class="col-lg-6">
                            <div>
                                <h3 class="fw-bolder h1 mb-4">Graphics Designer & Frontend Developer, Based in <span
                                        class="gradient-text gradient-horizon">Germany</span></h3>
                                <p class="mb-5 lead text-black-50 fw-extralight">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit. Earum, atque. Minus, harum porro unde quisquam! Minima vitae neque
                                    hic vel porro quidem totam.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget mt-5"
                                ...
                                <div class="oc-item">
                                    <div class="testimonial border-0 shadow-none bg-transparent">
                                        <div class="testi-content">
                                            <p>Quickly redefine resource sucking web services after exceptional customer
                                                service. Professionally coordinate focused platforms before visionary
                                                architectures.</p>
                                ...
                                <div class="oc-item">
                                    <div class="testimonial border-0 shadow-none bg-transparent">
                                        <div class="testi-content">
                                            <p>Dramatically mesh user friendly solutions whereas sticky human capital.
                                                Assertively fashion impactful "outside the box".</p>
                                            <div class="testi-meta d-flex align-items-center">
                                                <img src="demos/freelancer/images/testi/face2.jpg" alt="Face"
                                                     width="30">
                                                <div>
                                                    John Doe
                                                    <span class="ps-0">XYZ Inc.</span>
                                ...
                                <div class="oc-item">
                                    <div class="testimonial border-0 shadow-none bg-transparent">
                                        <div class="testi-content">
                                            <p>Progressively productivate customer directed meta-services without
                                                magnetic bandwidth.</p>
                                            <div class="testi-meta d-flex align-items-center">
                                                <img src="demos/freelancer/images/testi/face3.jpg" alt="Face"
                                                     width="30">
                                                <div>
                                                    John Doe
                                                    <span class="ps-0">XYZ Inc.</span>
            ...
            <div class="section m-0">
                <div class="container">
                    <div class="row align-items-end justify-content-between mb-5">
                        ...
                        <div class="col-auto">
                            <a href="demo-freelancer-works.html" class="button button-dark button-border rounded-pill">View
                    ...
                    <div class="row gutter-50 mb-5 align-items-stretch">
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center mb-4">
                                            ...
                                            <img src="demos/freelancer/images/icons/xd.png" height="50" alt="Image"
                                                 class="ms-3">
                                        </div>
                                        ...
                                        <p class="card-text mb-0 mt-2 fw-light">Objectively productivate interoperable
                                            ...
                                            architect resource-leveling portals.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="demos/freelancer/images/icons/hosting.svg" height="50" alt="Image"
                                             class="mb-4">
                        ...
                        <div class="col-md-4">
                            <div class="card d-flex align-items-end flex-column p-4 border-0"
                                ...
                                <div class="mt-auto">
                                    <div class="card-body">
                                        <img src="demos/freelancer/images/icons/plugins.png" height="50" alt="Image"
                                             class="mb-4">
                ...
                <div class="container mt-6">
                    ...
                    <div class="section rounded-10 p-6 my-4" style="background-color: #F1F1F1;">
                        <div class="row justify-content-between align-items-center col-mb-50">
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/amazon.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/netflix.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/google.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/paypal.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/skype.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/ps.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/slack.svg"
                                                                    alt="Clients"></div>
                            <div class="col-md-3 col-6 center"><img src="demos/freelancer/images/clients/applemusic.svg"
                                                                    alt="Clients"></div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="accordion" data-collapsible="true">
                                ...
                                <div class="accordion-content">Integer posuere erat a ante venenatis dapibus posuere
                                    ...
                                    sed consectetur. Cras mattis consectetur purus sit amet fermentum.
                                </div>
